...
namespace Post.Query.Infrastructure.Converter
{
    public class EventJsonConverter : JsonConverter<BaseEvent>
    {
        ...
        public override BaseEvent Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
        {
            ...
            {
                throw new JsonException($"Could not detect the Type discriminitor property!");
            }

            var typeDiscriminitor = type.GetString();
            var json = doc.RootElement.GetRawText();

            return typeDiscriminitor switch {
                ...
                _ => throw new JsonException($"{typeDiscriminitor} is not supported yet!")
            };
        }
